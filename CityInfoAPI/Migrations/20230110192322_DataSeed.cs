        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "The one with the cathedral that that was never really finished", "Antwerp" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "A 102-story sckyscraper located in Midtown Manhattan.", "Empire State Building" },
                    ...
                    { 5, 3, "Iron lattice tower on the Champ de Mars.", "Eiffel Tower" },
                    { 6, 3, "The world's largest museum.", "Louvre" }
                });
        }
